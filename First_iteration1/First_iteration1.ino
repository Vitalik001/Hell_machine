...
SoftwareSerial bluetooth_module(9, 10); // RX | TX pins for bluetooth module.
...
const int RESET=3;
const int TURNING_PIN_2=13;
const int TURNING_PIN_1=12;
const int V_5=11;
const int V_5_1=53;
...
void check_connection(){
  ...
  /* if ((loops_without_command > max_loops_without_command) && (max_loops_without_command!=0)){
    
    //if(total_commands_received < 10){
      //Serial.print(total_commands_received);
      //Serial.print("\n");
      //Serial.print(loops_without_command);
      //Serial.print("\n");
    //}
    ...
    Serial.print("Disbanding connection: too many loops without commands.\n");
    Serial.print("Total commands received: ");
    Serial.print(total_commands_received);
    Serial.print("\n");
    Serial.print("Max loops without commands: ");
    Serial.print(max_loops_without_command);
    Serial.print("\n");
    Serial.print("Time :");
    Serial.print(time_without_command);
    Serial.print("\n");
  }*/
